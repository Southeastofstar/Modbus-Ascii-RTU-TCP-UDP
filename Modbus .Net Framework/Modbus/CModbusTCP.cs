...
namespace Modbus
{
    ...
    public sealed class CModbusTCP : IModbusComm
    {
        ...
        /// </summary>
        public const int PosIndexOfDataLengthInTCPReceivedBytes = CModbusFuncCode.PosIndexOfDataLengthInSocketReceivedBytes;
        /// <summary>
        /// 接收到的字节数组中，从站地址的索引号[6]
        /// </summary>
        public const int PosIndexOfSlaveAddressInTCPReceivedBytes = CModbusFuncCode.PosIndexOfSlaveAddressInSocketReceivedBytes;
        /// <summary>
        /// 接收到的字节数组中，功能码的索引号[7]
        /// </summary>
        public const int PosIndexOfFuncCodeInTCPReceivedBytes = CModbusFuncCode.PosIndexOfFuncCodeInSocketReceivedBytes;
        /// <summary>
        /// 接收到的字节数组中，错误码的索引号[7]
        /// </summary>
        public const int PosIndexOfErrorCodeInTCPReceivedBytes = CModbusFuncCode.PosIndexOfFuncCodeInSocketReceivedBytes;
        /// <summary>
        /// 执行读取操作时，接收到的字节数组中，接收到的数据开始的索引号[9]
        /// </summary>
        public const int PosIndexOfDataInTCPReceivedBytes = CModbusFuncCode.PosIndexOfDataInSocketReceivedBytes;
        ...
        private CReadbackData UnpackReceivedRTUMsg(byte[] ReceivedMsg)
        {
            ...
            try
            {
                ...
                gotData.SlaveAddress = ReceivedMsg[PosIndexOfSlaveAddressInTCPReceivedBytes];
                gotData.FuncCode = ReceivedMsg[PosIndexOfFuncCodeInTCPReceivedBytes];
                gotData.FuncDescription = CModbusFuncCode.FuncInfo((ModbusFuncCode)gotData.FuncCode);
                gotData.ErrorCode = ReceivedMsg[PosIndexOfErrorCodeInTCPReceivedBytes];
